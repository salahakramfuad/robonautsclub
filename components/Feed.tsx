...
const Feed = () => {
  ...
  return (
    <div className="w-full min-w-full">
      ...
      {/* Why Us Section */}
      <section className="py-24 bg-linear-to-br from-indigo-50/50 via-blue-50/50 to-purple-50/30 relative overflow-hidden">
      ...
      <section className="py-24 bg-linear-to-br from-indigo-50/80 via-blue-50/60 to-purple-50/40 relative">
        <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-gray-200 to-transparent" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
      ...
      {/* FAQ Section */}
      <section className="py-24 bg-linear-to-br from-blue-50/80 via-indigo-50/60 to-purple-50/40 relative">
        <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-gray-200 to-transparent" />
