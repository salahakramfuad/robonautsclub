      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[95vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
        ...
        <div className="flex-1 overflow-y-auto">
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            {/* Blurb/Description */}
            <div className="space-y-2">
              <label htmlFor="blurb" className="flex items-center gap-2 text-sm font-semibold text-gray-700">
            ...
            {/* Link/Href */}
            <div className="space-y-2">
              <label htmlFor="href" className="flex items-center gap-2 text-sm font-semibold text-gray-700">
